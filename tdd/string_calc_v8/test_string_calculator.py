...
class TestStringCalculator(unittest.TestCase):
    ...
    def test_negative_error_present_when_multiple_errors(self):
        """
        Ensures that negative numbers are reported even when multiple errors occur.
        """
        try:
            exercise.add("2,-4,-9")
        except ValueError as e:
    ...
    def test_combining_negative_number_and_wrong_separator_errors(self):
        """
        Ensures that both negative number and wrong separator errors are reported together.
        """
        with self.assertRaises(ValueError) as context:
            exercise.add("//|\n1|2,-3")
...
class TestStringCalculator2(unittest.TestCase):
    """
    Test
    """
    ...
    def test_number_greater_than_1000_is_ignored(self):
        """
        Ensures that numbers greater than 1000 are ignored.
        """
    ...
    def test_number_equal_to_1000_is_included(self):
        """
        Ensures that the number 1000 is included in the sum.
        """
    ...
    def test_multiple_large_numbers_are_ignored(self):
        """
        Ensures that multiple numbers greater than 1000 are ignored.
        """
